...
namespace Wyam.BlogEx
{
    ...
    /// </summary>
    public static class BlogExKeys
    {
        ...
        /// <summary>
        /// The page size for category archive pages (if not specified, no paging will be used).
        /// </summary>
        /// <type><see cref="int"/></type>
        ...
        /// <summary>
        /// The categories for a given post.
        /// </summary>
        /// <type><see cref="string"/> or <c>IEnumerable&lt;string&gt;</c></type>
        ...
        /// <summary>
        /// Set by the recipe to the name of the category for each tag group.
        /// </summary>
        /// <type><see cref="string"/></type>
